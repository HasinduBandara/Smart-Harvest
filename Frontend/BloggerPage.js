...
function BloggerPage() {
    ...
    const [blogID, setBlogID] = useState(99);
    const [bloggerName, setBloggerName] = useState();
    /* const [titleo, setBloggerName2] = useState(); */ //correct onee
    const [bloggerPosition, setBloggerPosition] = useState();
    const [title, setTitle] = useState();
    /* const [titleo, setTitleo] = useState(); */
    ...
    const Validate = (e) => {
       ...
       /*  formData.append("titleo", titleo);//sss */
        ...
        <>
            ...
            <Container style={{ backgroundColor: 'LightGray', marginTop: '60px', width: '80%', padding: '40px', borderRadius: '5px' }}>
                ...
                <Form onSubmit={Validate} >
                 ...
                 {/*    <Form.Group as={Col} controlId="formGridProductID">
                        <Form.Label>Blogger Feature 2: </Form.Label> 
                        <Form.Control type="text" placeholder="Enter Blogger Feature" onChange={(e) => { setBloggerName2(e.target.value) }} />
                            </Form.Group>  */}
