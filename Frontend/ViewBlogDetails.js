        ...
        <>
            <Container style={{ backgroundColor: 'white', width: '100%', borderRadius: '15px' }}>
                ...
                <Table striped bordered hover style={{ width: '100%', justifyContent:'center', marginTop: '10px' }}>
                    ...
                    <tbody>        
                        {blogs.filter((element) => {  //search
                            if (search == "") {
                                return element;
                            } else if ((element.bloggerName.toLowerCase()).includes(search.toLowerCase()) || (element.content.toLowerCase()).includes(search.toLowerCase())) {
                                return element;
                            }
                        }).map((elem, id) => (
                ...
                <Button varient="outline-primary"         //report gen
                    onClick={() => ReportGenerator(
                        ...
                        )), columnsPDF, false, "Blog Details")} style={{ marginBottom:18 }}>Download Blog Details</Button>
                <ToastContainer
                    position="top-center"
                    autoClose={4000}
